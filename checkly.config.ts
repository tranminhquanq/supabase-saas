...
const productionURL = 'https://demo.supabase-saas.com';
...
export const config = defineConfig({
  ...
  projectName: 'Supabase Saas Boilerplate',
  logicalId: 'supabase-saas-boilerplate',
  repoUrl: 'https://github.com/tranminhquanq/supabase-saas',
  checks: {
